...
/*
 *  idx                     Markets             HotelRooms
 *  0 (rooms)/0 (market)    liab                date
 *  0 (rooms)/0 (market)    collat              nights_booked
 *  0 (rooms)/1 (market)    liab                nights_slept
 *  1 (rooms)/1 (market)    collat              date
 *  1 (rooms)/2 (market)    liab                nights_booked
 *  1 (rooms)/2 (market)    collat              nights_slept
 */
